...
/**
 ** \file C:/Users/Filippo/Desktop/nbtisym/src/parser/parser.hh
 ** Define the yy::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_C_USERS_FILIPPO_DESKTOP_NBTISYM_SRC_PARSER_PARSER_HH_INCLUDED
# define YY_YY_C_USERS_FILIPPO_DESKTOP_NBTISYM_SRC_PARSER_PARSER_HH_INCLUDED
// //                    "%code requires" blocks.
#line 11182 "./doc/bison.texi" // lalr1.cc:371

# include <string>
class calcxx_driver;

#line 49 "C:/Users/Filippo/Desktop/nbtisym/src/parser/parser.hh" // lalr1.cc:371
...
namespace yy {
#line 72 "C:/Users/Filippo/Desktop/nbtisym/src/parser/parser.hh" // lalr1.cc:371
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ID_FIELD (const location_type& l);

    static inline
    symbol_type
    make_DC_FIELD (const location_type& l);

    static inline
    symbol_type
    make_VDD_FIELD (const location_type& l);

    static inline
    symbol_type
    make_FREQ_FIELD (const location_type& l);
  ...
  template <typename Base>
  calcxx_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const float v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_COLON (const location_type& l)
  {
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_ID_FIELD (const location_type& l)
  {
    return symbol_type (token::TOK_ID_FIELD, l);

  }

  calcxx_parser::symbol_type
  calcxx_parser::make_DC_FIELD (const location_type& l)
  {
    return symbol_type (token::TOK_DC_FIELD, l);

  }

  calcxx_parser::symbol_type
  calcxx_parser::make_VDD_FIELD (const location_type& l)
  {
    return symbol_type (token::TOK_VDD_FIELD, l);

  }

  calcxx_parser::symbol_type
  calcxx_parser::make_FREQ_FIELD (const location_type& l)
  {
    return symbol_type (token::TOK_FREQ_FIELD, l);
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_NUMBER (const float& v, const location_type& l)
  {
...
#line 927 "C:/Users/Filippo/Desktop/nbtisym/src/parser/parser.hh" // lalr1.cc:371




#endif // !YY_YY_C_USERS_FILIPPO_DESKTOP_NBTISYM_SRC_PARSER_PARSER_HH_INCLUDED
